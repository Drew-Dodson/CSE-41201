 ...
 */
var numberOfDaysInAMonth = ["January" : 31, "February" : 28, "March" : 31]
 ...
 */
numberOfDaysInAMonth.updateValue(29, forKey: "February")
print(numberOfDaysInAMonth)
/*:
 Use if-let syntax to retrieve the number of days under "January". If the value is there, print "January has 31 days", where 31 is the value retrieved from the dictionary.
 */
if let january = numberOfDaysInAMonth["January"] {
 ...
 */
print(newDictionary)
if let element = newDictionary["Colors"] {
    print(element)
}
