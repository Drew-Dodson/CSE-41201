...
var myShape = Rectangle(width: 2, height: 3)
print(myShape.area)
/*:
    ...
    var heightInInches: Double {
        didSet {
            if heightInCentimeters != oldValue * 2.54 {
                heightInCentimeters = oldValue * 2.54
            }
        }
    }
...
var newHeight = Height(heightInCentimeters: 2)
print(newHeight.heightInCentimeters)
print(newHeight.heightInInches)
newHeight.heightInInches = 3
print(newHeight.heightInCentimeters)
print(newHeight.heightInInches)
