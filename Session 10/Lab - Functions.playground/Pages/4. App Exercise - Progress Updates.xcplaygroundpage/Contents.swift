...
func progressUpdate(steps: Int, goal: Int) {
    if ((Double(steps) / Double(goal)) * 100.00) < 10.0 {
        print("You're off to a good start.")
    } else if ((Double(steps) / Double(goal)) * 100.00) < 50.0 {
        print("You're almost halfway there!")
    } else if ((Double(steps) / Double(goal)) * 100.00) < 90.0 {
        print("You're over halfway there!")
    } else if ((Double(steps) / Double(goal)) * 100.00) < 100.0 {
        print("You're almost there!")
    } else {
        print("You beat your goal!")
    }
}
progressUpdate(steps: 5567, goal: 10000)
/*:
